...
import com.example.repository.model3.RepoEmployemodel3;
import com.example.repository.model3.RepoServicemodel3;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_model3")
public class ControllerRepmodel3 {
	
	@Autowired 
	private   RepoEmployemodel3 red ;
	@Autowired 
	private   RepoServicemodel3 rsd ;

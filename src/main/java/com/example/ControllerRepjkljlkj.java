...
import com.example.repository.jkljlkj.RepoEmployejkljlkj;
import com.example.repository.jkljlkj.RepoServicejkljlkj;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_jkljlkj")
public class ControllerRepjkljlkj {
	
	@Autowired 
	private   RepoEmployejkljlkj red ;
	@Autowired 
	private   RepoServicejkljlkj rsd ;

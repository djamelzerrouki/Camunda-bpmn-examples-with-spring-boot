...
import com.example.repository.model5.RepoEmployemodel5;
import com.example.repository.model5.RepoServicemodel5;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_model5")
public class ControllerRepmodel5 {
	
	@Autowired 
	private   RepoEmployemodel5 red ;
	@Autowired 
	private   RepoServicemodel5 rsd ;

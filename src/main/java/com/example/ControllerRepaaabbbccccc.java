...
import com.example.repository.aaabbbccccc.RepoEmployeaaabbbccccc;
import com.example.repository.aaabbbccccc.RepoServiceaaabbbccccc;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_aaabbbccccc")
public class ControllerRepaaabbbccccc {
	
	@Autowired 
	private   RepoEmployeaaabbbccccc red ;
	@Autowired 
	private   RepoServiceaaabbbccccc rsd ;

...
import com.example.repository.pasporte.RepoEmployepasporte;
import com.example.repository.pasporte.RepoServicepasporte;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_pasporte")
public class ControllerReppasporte {
	
	@Autowired 
	private   RepoEmployepasporte red ;
	@Autowired 
	private   RepoServicepasporte rsd ;

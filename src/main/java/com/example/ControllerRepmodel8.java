...
import com.example.repository.model8.RepoEmployemodel8;
import com.example.repository.model8.RepoServicemodel8;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_model8")
public class ControllerRepmodel8 {
	
	@Autowired 
	private   RepoEmployemodel8 red ;
	@Autowired 
	private   RepoServicemodel8 rsd ;

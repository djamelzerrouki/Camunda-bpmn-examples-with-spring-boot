...
import com.example.repository.k.RepoEmployek;
import com.example.repository.k.RepoServicek;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_k")
public class ControllerRepk {
	
	@Autowired 
	private   RepoEmployek red ;
	@Autowired 
	private   RepoServicek rsd ;

...
import com.example.repository.model4.RepoEmployemodel4;
import com.example.repository.model4.RepoServicemodel4;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_model4")
public class ControllerRepmodel4 {
	
	@Autowired 
	private   RepoEmployemodel4 red ;
	@Autowired 
	private   RepoServicemodel4 rsd ;

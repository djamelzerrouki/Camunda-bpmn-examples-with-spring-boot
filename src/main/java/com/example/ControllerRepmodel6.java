...
import com.example.repository.model6.RepoEmployemodel6;
import com.example.repository.model6.RepoServicemodel6;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_model6")
public class ControllerRepmodel6 {
	
	@Autowired 
	private   RepoEmployemodel6 red ;
	@Autowired 
	private   RepoServicemodel6 rsd ;

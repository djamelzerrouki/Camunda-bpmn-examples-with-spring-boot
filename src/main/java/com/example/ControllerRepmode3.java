...
import com.example.repository.mode3.RepoEmployemode3;
import com.example.repository.mode3.RepoServicemode3;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_mode3")
public class ControllerRepmode3 {
	
	@Autowired 
	private   RepoEmployemode3 red ;
	@Autowired 
	private   RepoServicemode3 rsd ;

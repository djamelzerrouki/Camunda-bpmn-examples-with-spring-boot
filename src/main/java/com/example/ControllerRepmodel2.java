...
import com.example.repository.model2.RepoEmployemodel2;
import com.example.repository.model2.RepoServicemodel2;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_model2")
public class ControllerRepmodel2 {
	
	@Autowired 
	private   RepoEmployemodel2 red ;
	@Autowired 
	private   RepoServicemodel2 rsd ;

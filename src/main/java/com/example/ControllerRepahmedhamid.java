...
import com.example.repository.ahmedhamid.RepoEmployeahmedhamid;
import com.example.repository.ahmedhamid.RepoServiceahmedhamid;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_ahmedhamid")
public class ControllerRepahmedhamid {
	
	@Autowired 
	private   RepoEmployeahmedhamid red ;
	@Autowired 
	private   RepoServiceahmedhamid rsd ;

...
import com.example.repository.model1.RepoEmployemodel1;
import com.example.repository.model1.RepoServicemodel1;
import com.exomple.configfile.Config;
@Controller 
@RequestMapping(value="/model_model1")
public class ControllerRepmodel1 {
	
	@Autowired 
	private   RepoEmployemodel1 red ;
	@Autowired 
	private   RepoServicemodel1 rsd ;
